...
class UserController extends BaseController
{
    ...
    {
        // 获取用户信息
        $userList = $this->userInfoApi->listByBroker()->getData();
        ...
        // 获取用户列表统计详情
        $userTotal = $this->userInfoApi->userBrokerStatistic()->getData();
    ...
    public function wallet_log()
    {
        ...
        // 获取所有代理商信息
        $agentInfo = $this->userInfoApi->getAgentInfo()->getData();
        $this->assign('agentInfo', $agentInfo['code'] == 1 ? $agentInfo['data'] : []);
        // 获取所有经济人信息
        $brokerInfo = $this->userInfoApi->getBrokerInfo()->getData();
