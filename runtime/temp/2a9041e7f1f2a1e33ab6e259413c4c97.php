<?php /*a:2:{s:72:"/www/wwwroot/stock.ecou.vip/application/dash/view/agent/show_broker.html";i:1540954492;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="<?php echo url('agent/reset_pwd', ['id' => $nl['id']]); ?>">重置密码</a>
                                    </td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
