<?php /*a:2:{s:70:"/www/wwwroot/stock.ecou.vip/application/dash/view/order/condition.html";i:1548380744;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <form id="searchInfo" action="<?php echo url('condition'); ?>" method="get" autocomplete="off">
                            <div class="col-sm-12 no-padding">
                                <div class="search-box">
                                    <label class="text-right">股票代码</label>
                                    <div class="search-body">
                                        <input class="form-control" id="stockCode" name="stock_code" type="text"
                                               value="<?php echo !empty($stock_code) ? htmlentities($stock_code) : ''; ?>">
                                    </div>
                                </div>
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <input class="form-control" type="text" name="mobile" id="mobile"
                                               value="<?php echo !empty($mobile) ? htmlentities($mobile) : ''; ?>">
                                    </div>
                                </div>
                                <div class="search-box">
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select class="form-control" name="direction" id="direction">
                                            ...
                                            <?php foreach($directionList as $k=>$v): ?>
                                            <option value="<?php echo htmlentities($k); ?>" <?php echo isset($direction) && $k==$direction?'selected':''; ?>>
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <input class="form-control" name="order_position_id" id="orderPositionId"
                                               type="text" value="<?php echo !empty($order_position_id) ? htmlentities($order_position_id) : ''; ?>">
                                    </div>
                                </div>
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select class="form-control" name="state" id="state">
                                            ...
                                            <option value="<?php echo htmlentities($k); ?>" <?php echo isset($state) && $k==$state?'selected':''; ?>>
                                                <?php echo htmlentities($v); ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
                        ...
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <?php echo !empty($v['stock_code']) ? htmlentities($list['stockInfo'][$v['market'].$v['stock_code']]['stock_name']) : ''; ?>
                                </td>
                                <td <?php echo $v['direction']=='buy' ? "class='buy'" : "class='sell'"; ?>><?php echo !empty($v['direction']) ? htmlentities($directionList[$v['direction']]) : ''; ?></td>
                                <td><?php echo !empty($v['order_position_id']) ? htmlentities($v['order_position_id']) : ''; ?></td>
                                <td <?php echo $v['state']=='ing' ? "class='text-green'" : ""; ?>>
                                    <?php echo !empty($v['state']) ? htmlentities($stateList[$v['state']]) : ''; ?>
                                </td>
                                <td>现价 <?php echo $v['trigger_compare']=='egt' ? '>=' : '<='; ?> <?php echo htmlentities($v['trigger_price']); ?></td>
                                <td><?php echo $v['price']!=0 ? htmlentities($v['price']) : ''; if($v['price_type']=='market_price'): ?>
                                    <?php echo htmlentities($priceType[$v['price_type']]); ?>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo !empty($v['order_id']) ? htmlentities($v['order_id']) : ''; ?></td>
