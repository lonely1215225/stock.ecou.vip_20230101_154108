<?php /*a:2:{s:67:"/www/wwwroot/stock.ecou.vip/application/dash/view/order/traded.html";i:1572238770;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select class="form-control" id="agentId" name="agent_id"
                                            ...
                                            <option value="<?php echo htmlentities($k); ?>" <?php echo isset($agent_id) &&
                                                    $k==$agent_id?'selected':''; ?>><?php echo htmlentities($v); ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <input class="form-control" name="primary_account" id="primaryAccount"
                                               type="text" value="<?php echo !empty($primary_account) ? htmlentities($primary_account) : ''; ?>">
                                    </div>
                                </div>
                                <div class="search-box">
                    ...
                    <div class="box-body no-padding table-scroll-x" id="scroll_tab"  onscroll="scrollWindow(this,'div1')">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr <?php echo $v['direction']=='buy' ? "class='buy'" : "class='sell'"; ?>>
                                ...
                                <td>
                                    <a href="<?php echo url('user/index',['mobile'=>$v['mobile']]); ?>" target="_blank"
