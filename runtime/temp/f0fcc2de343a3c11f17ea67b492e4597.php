<?php /*a:2:{s:73:"/www/wwwroot/stock.ecou.vip/application/dash/view/notice/notice_edit.html";i:1540192288;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input class="form-control" type="hidden" name="state" id="stae" value="<?php echo !empty($editInfo['stae']) ? htmlentities($editInfo['stae']) : '0'; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control"  id="content" name="content"><?php echo !empty($editInfo['content']) ? htmlentities($editInfo['content']) : ''; ?></textarea>
                                </div>
                            </div>
                        </div>
    ...
    $(function () {
        $("#addForm").submit(function(){
            ...
            if(title == "") {
                ...
                $.post("<?php echo url('stock/notice/saveNotice'); ?>", {title:title,content:content,id:id}, function(data){
                    if(data.code == 1){
