<?php /*a:2:{s:70:"/www/wwwroot/stock.ecou.vip/application/dash/view/risk/edit_stock.html";i:1656315336;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="box box-info">
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="stock_code" id="stockCode"
                                           value="<?php echo !empty($stockInfo['stock_code']) ? htmlentities($stockInfo['stock_code']) : ''; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="stock_name" id="stockName"
                                           value="<?php echo !empty($stockInfo['stock_name']) ? htmlentities($stockInfo['stock_name']) : ''; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-4">
                                    <select id="isMargin" name="is_margin" class="form-control">
                                        <option value="0" <?php echo isset($stockInfo) && 0==$stockInfo['is_margin']?'selected':''; ?>>否
                                        </option>
                                        <option value="1" <?php echo isset($stockInfo) && 1==$stockInfo['is_margin']?'selected':''; ?>>是
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-4">
                                    <select id="market" name="market" class="form-control">
                                        ...
                                        <option value="<?php echo htmlentities($mk); ?>" <?php echo isset($stockInfo) &&
                                                $stockInfo['market']==$mk?'selected':''; ?>><?php echo htmlentities($mv); ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-4">
                                    <select id="riskLevel" name="risk_level" class="form-control">
                                        <?php foreach($riskList as $fk=>$fv): ?>
                                        <option value="<?php echo htmlentities($fk); ?>" <?php echo isset($stockInfo) &&
                                                $stockInfo['risk_level']==$fk?'selected':''; ?>><?php echo htmlentities($fv); ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="initial" id="initial" value="<?php echo !empty($stockInfo['initial']) ? htmlentities($stockInfo['initial']) : ''; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-4">
                                    <select id="isKeChuang" name="isKeChuang" class="form-control">
                                        <option value="false" <?php echo isset($stockInfo) && $stockInfo['is_kechuang']==false?'selected':''; ?>>否</option>
                                        <option value="true" <?php echo isset($stockInfo) && $stockInfo['is_kechuang']==true?'selected':''; ?>>是</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-8 checkbox">
                                    <label>
                                        <input type="checkbox" name="is_selective" id="is_selective" <?php echo !empty($stockInfo['is_selective']) ? 'checked' : ''; ?>>
                                    </label>
                                </div>
                            </div>
                        </div>
...
$(function () {
    $("#ruleForm").submit(function () {
        ...
        if (stockCode == "") {
            ...
            $.post("<?php echo url('stock/stock/saveStock'); ?>", {
                id: id,
