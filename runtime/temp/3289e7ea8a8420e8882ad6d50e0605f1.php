<?php /*a:2:{s:68:"/www/wwwroot/stock.ecou.vip/application/dash/view/user/add_user.html";i:1546491004;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    $(function () {
        $("#addForm").submit(function(){
            ...
            if(mobile == "") {
                ...
                $.post("<?php echo url('user/saveUser'); ?>", {mobile:mobile,agent_id:agent_id,broker_id:broker_id,code:code,password:password,confirm:confirm}, function(data){
                    if(data.code == 1){
