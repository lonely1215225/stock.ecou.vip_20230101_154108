<?php /*a:2:{s:67:"/www/wwwroot/stock.ecou.vip/application/dash/view/news/contact.html";i:1540863794;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tbody>
                            <tr>
                                <td><a href="<?php echo url('news/contact_edit', ['id'=>$contactInfo['id']]); ?>" class="name"><?php echo htmlentities($contactInfo['title']); ?></a></td>
                                <td>
                                    <a class="btn btn-sm btn-primary" href="<?php echo url('news/contact_edit', ['id' => $contactInfo['id']]); ?>">编辑</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
