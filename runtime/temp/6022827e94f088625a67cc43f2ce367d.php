<?php /*a:2:{s:70:"/www/wwwroot/stock.ecou.vip/application/dash/view/risk/suspension.html";i:1542937220;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header">
                        <a href="<?php echo url('risk/edit_suspension'); ?>" class="btn btn-success"><i class="fa fa-plus"></i>
                            添加停牌复牌</a>
                        <form id="searchInfo" action="<?php echo url('suspension'); ?>" method="get">
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select id="isSuspension" name="is_suspension" class="form-control">
                                            ...
                                            <option value="1" <?php echo $is_suspension!="" && 1==$is_suspension?'selected':''; ?>>未复牌</option>
                                            <option value="2" <?php echo $is_suspension!="" && 2==$is_suspension?'selected':''; ?>>已复牌</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="search-box">
                    ...
                    <!--div class="box-body no-padding">
                        <table class="table table-bordered table-middle">
                            <tr>
                                <td>
                                    停牌复牌总数：<?php echo !empty($suspensionTotal) ? htmlentities($suspensionTotal) : '0'; ?>
                                </td>
                            </tr>
                        </table>
                    </div-->
                    <div class="box-body">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tbody>
                            <?php foreach($susInfo['infoList'] as $k=>$nl): ?>
                            <tr>
                                    <td>
                                        <?php echo htmlentities($nl['market']); ?><?php echo htmlentities($nl['stock_code']); ?>
                                    </td>
                                    <td>
                                        <?php echo !empty($susInfo['stockName'][$nl['market'].$nl['stock_code']]['stock_name']) ? htmlentities($susInfo['stockName'][$nl['market'].$nl['stock_code']]['stock_name']) : ''; ?>
                                    </td>
                                    <td><?php echo $nl['suspension_date']=='0000-00-00' ? ''  : htmlentities($nl['suspension_date']); ?></td>
                                    <td><?php echo $nl['resumption_date']=='0000-00-00' ? ''  : htmlentities($nl['resumption_date']); ?></td>
                                    <td><a class="btn btn-sm btn-primary"
                                           href="<?php echo url('risk/edit_suspension', ['id' => $nl['id']]); ?>">编辑</a></td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="box-footer">
                        <div class="col-sm-12 no-padding"><?php echo $susInfo['infoList']->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
