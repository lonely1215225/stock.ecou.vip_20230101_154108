<?php /*a:2:{s:67:"/www/wwwroot/stock.ecou.vip/application/dash/view/broker/index.html";i:1543281902;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr class="tj">
                                ...
                                <td></td>
                                <td></td>
                                <td><?php echo !empty($brokerDetail['totalMoney']['totalbalance']) ? htmlentities($brokerDetail['totalMoney']['totalbalance']) : ''; ?></td>
                                <td><?php echo !empty($brokerDetail['totalMoney']['totalcommission']) ? htmlentities($brokerDetail['totalMoney']['totalcommission']) : ''; ?></td>
                                <td><?php echo !empty($brokerDetail['totalMoney']['totalwithdraw']) ? htmlentities($brokerDetail['totalMoney']['totalwithdraw']) : ''; ?></td>
                                <td></td>
                                <td></td>
                            </tr>
                            </thead>
                            ...
                            <?php foreach($brokerInfo as $k=>$nl): ?>
                            <tr>
                                    ...
                                    <td><?php echo !empty($orgAccount[$nl['id']]['balance']) ? htmlentities($orgAccount[$nl['id']]['balance']) : '0.0000'; ?></td>
                                    <td><?php echo !empty($orgAccount[$nl['id']]['total_commission']) ? htmlentities($orgAccount[$nl['id']]['total_commission']) : '0.0000'; ?></td>
                                    <td><?php echo !empty($orgAccount[$nl['id']]['total_withdraw']) ? htmlentities($orgAccount[$nl['id']]['total_withdraw']) : '0.0000'; ?></td>
                                    <td>
                                        <?php echo !empty($nl['code']) ? htmlentities($nl['code']) : ''; ?>
                                        <br>
                                        <a href="#" onclick="openDialog('<?php echo htmlentities($nl['id']); ?>');">编辑推广码</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="<?php echo url('broker/reset_pwd', ['id' => $nl['id']]); ?>">重置密码</a>
                                    </td>
                            </tr>
                            <?php endforeach; ?>
                        </table>
                    ...
                    <div class="box-footer">
                        <div class="col-sm-12 no-padding"><?php echo $brokerInfo->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
function saveNewCode(id,code) {
    if (id == '') {
        ...
        $.post("<?php echo url('stock/broker/saveNewCode'); ?>",{id:id,code:code}, function(data){
            if(data.code == 1){
