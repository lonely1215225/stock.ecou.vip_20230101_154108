<?php /*a:2:{s:70:"/www/wwwroot/stock.ecou.vip/application/dash/view/agent/reset_pwd.html";i:1540955894;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
$(function(){
    $("#agentForm").submit(function(){
        ...
        if (id == 0 && password == '') {
            ...
            $.post("<?php echo url('stock/agent/saveNewPwd'); ?>",{id:id,password:password}, function(data){
                if(data.code == 1){
