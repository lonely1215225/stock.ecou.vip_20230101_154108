<?php /*a:2:{s:75:"/www/wwwroot/stock.ecou.vip/application/dash/view/user/cash_coupon_log.html";i:1572424320;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <form id="searchInfo" action="<?php echo url('cash_coupon_log'); ?>" method="get">
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select class="form-control" id="changeType" name="change_type">
                                            ...
                                            <?php foreach($strategyChangeType as $key=>$item): ?>
