<?php /*a:2:{s:70:"/www/wwwroot/stock.ecou.vip/application/dash/view/settings/config.html";i:1660973521;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4" style="float:left;">
                                    <input class="form-control" name="h5_url" id="h5_url" value="<?php echo htmlentities($config['h5_url']); ?>">
                                </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-1 checkbox">
                                    <label><input type="checkbox" name="is_share" id="is_share" <?php echo $config['is_share']==1 ? 'checked' : ''; ?> value="0"></label>
                                </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4" style="float:left;">
                                    <input class="form-control" name="banner_url" id="banner_url" value="<?php echo htmlentities($config['banner_url']); ?>">
                                </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <input class="form-control" name="kefu_link" id="kefu_link" value="<?php echo htmlentities($config['kefu_link']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">客服电话</label>
                                <div class="input-group col-sm-4">
                                    <input class="form-control" name="kefuphone" id="kefuphone" value="<?php echo htmlentities($config['kefuphone']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">允许注册</label>
                                <div class="col-sm-1 checkbox">
                                    <label><input type="checkbox" name="is_regist" id="is_regist" <?php echo $config['is_regist']==1 ? 'checked' : ''; ?> value="0"></label>
                                </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-1 checkbox">
                                    <label><input type="checkbox" name="is_invita" id="is_invita" <?php echo $config['is_invita']==1 ? 'checked' : ''; ?> value="0"></label>
                                </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-1 checkbox">
                                    <label><input type="checkbox" name="is_smsreg" id="is_smsreg" <?php echo $config['is_smsreg']==1 ? 'checked' : ''; ?> value="0"></label>
                                </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <input class="form-control" name="sms_use" id="sms_use" value="<?php echo htmlentities($config['sms_use']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">短信平台密码</label>
                                <div class="input-group col-sm-4">
                                    <input class="form-control" type="password" name="sms_pwd" id="sms_pwd" value="<?php echo htmlentities($config['sms_pwd']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">短信平台签名</label>
                                <div class="input-group col-sm-4" style="float:left;">
                                    <input class="form-control" name="sms_name" id="sms_name" value="<?php echo htmlentities($config['sms_name']); ?>">
                                </div>
...
<script>
    ...
    $("#appConfigForm").submit(function () {
        ...
        $.post("<?php echo url('stock/system/saveConfig'); ?>", $(this).serializeArray(), function (data) {
            if (data.code == 1) {
