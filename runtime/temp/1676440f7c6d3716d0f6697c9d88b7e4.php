<?php /*a:2:{s:68:"/www/wwwroot/stock.ecou.vip/application/agent/view/broker/index.html";i:1543285040;s:67:"/www/wwwroot/stock.ecou.vip/application/agent/view/base/layout.html";i:1551173342;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <a href="<?php echo url('broker/edit_broker'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> 添加经济人</a>
                    </div>
                    <div class="box-header with-border">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr class="tj">
                                ...
                                <td></td>
                                <td></td>
                                <td><?php echo !empty($brokerDetail['totalbalance']) ? htmlentities($brokerDetail['totalbalance']) : 0; ?></td>
                                <td><?php echo !empty($brokerDetail['totalcommission']) ? htmlentities($brokerDetail['totalcommission']) : 0; ?></td>
                                <td><?php echo !empty($brokerDetail['totalwithdraw']) ? htmlentities($brokerDetail['totalwithdraw']) : 0; ?></td>
                                <td></td>
                                <td></td>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                    ...
                                    <td><?php echo !empty($nl['code']) ? htmlentities($nl['code']) : ''; ?></td>
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="<?php echo url('broker/edit_broker', ['id' => $nl['id']]); ?>">编辑</a>
