<?php /*a:2:{s:65:"/www/wwwroot/stock.ecou.vip/application/dash/view/user/index.html";i:1654400080;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="box box-info">
                            ...
                            <div class="col-sm-12 no-padding">
                                <div class="search-box">
                                    ...
                                    <div class="search-body"><input class="form-control" type="text" id="mobile"
                                                                    name="mobile" value="<?php echo isset($mobile)?$mobile:''; ?>">
                                    </div>
                                </div>
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select class="form-control" id="agentId" name="agent_id"
                                            ...
                                            <option value="<?php echo htmlentities($k); ?>" <?php echo isset($agent_id) && $k==$agent_id?'selected':''; ?>>
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select id="noAgentId" name="no_agent_id[]" multiple="multiple">
                                            <?php foreach($agentList as $k=>$v): ?>
                                            <option value="<?php echo htmlentities($k); ?>" <?php echo $no_agent_id && in_array($k,$no_agent_id)?
                                            'selected':''; ?>><?php echo htmlentities($v); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                    ...
                    <!--div class="box-body no-padding">
                        <table class="table table-bordered table-middle">
                            <tr>
                                <td>
                                    总用户数量:<?php echo !empty($userTotal['userTotal']) ? htmlentities($userTotal['userTotal']) : ''; ?>&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr class="tj">
                                ...
                                <td><?php echo !empty($userTotal['totalAccount']['cashcoupon']) ? htmlentities($userTotal['totalAccount']['cashcoupon']) : 0; ?></td>
                                <td colspan="2"></td>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo url('generalize_user_list',['pid' => $nl['id']]); ?>"><?php echo htmlentities($nl['mobile']); ?><br><?php echo !empty($nl['real_name']) ? htmlentities($nl['real_name']) : ''; ?></a>
                                </td>
                                <td>
                                    <a href="<?php echo url('wallet_log', ['mobile' => $nl['mobile']]); ?>" target="_blank"
                                       title="点击打开用户钱包流水">
                                ...
                                <td>
                                    <a href="<?php echo url('strategy_log', ['mobile' => $nl['mobile']]); ?>" target="_blank"
                                       title="点击打开用户策略流水">
                                ...
                                <td><?php echo !empty($userList['userAccountList'][$nl['id']]['cash_coupon']) ? htmlentities($userList['userAccountList'][$nl['id']]['cash_coupon']) : ''; ?></td>
                                <!--<td><?php echo !empty($userList['userAccountList'][$nl['id']]['cash_coupon_frozen']) ? htmlentities($userList['userAccountList'][$nl['id']]['cash_coupon_frozen']) : ''; ?></td>
                                <td><?php if(!(empty($userList['userAccountList'][$nl['id']]['cash_coupon_uptime']) || (($userList['userAccountList'][$nl['id']]['cash_coupon_uptime'] instanceof \think\Collection || $userList['userAccountList'][$nl['id']]['cash_coupon_uptime'] instanceof \think\Paginator ) && $userList['userAccountList'][$nl['id']]['cash_coupon_uptime']->isEmpty()))): ?><?php echo htmlentities(date("Y-m-d
                                    H:i:s",!is_numeric($userList['userAccountList'][$nl['id']]['cash_coupon_uptime'])? strtotime($userList['userAccountList'][$nl['id']]['cash_coupon_uptime']) : $userList['userAccountList'][$nl['id']]['cash_coupon_uptime'])); else: ?>-&#45;&#45;<?php endif; ?>
                                </td>-->
                                ...
                                <td>
                                    <?php echo $nl['is_deny_login']=='0' ? '否' : '是'; ?>
                                    <br>
                                    <a href="#" onclick="saveDenyLogin('<?php echo htmlentities($nl['id']); ?>');">编辑</a>
                                </td>
                                <td><?php echo !empty($nl['login_ip']) ? htmlentities($nl['login_ip']) : '0.0.0.0'; ?><br><?php echo !empty($nl['update_time']) ? htmlentities($nl['update_time']) : '--'; ?></td>
                                <td>
                                    <a class="btn btn-sm btn-primary mb5"
                                       href="<?php echo url('user_detail', ['id' => $nl['id']]); ?>">详情</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            <?php endif; ?>
    ...
    function saveDenyLogin(id) {
        layer.confirm('确定要更改禁止登录状态？', {
            ...
            if (id == '') {
                ...
                $.post("<?php echo url('stock/user/is_deny_login'); ?>", {id: id}, function (data) {
                    if (data.code == 1) {
                        layer.msg(data.msg, {icon: 1, time: 1500, shade: .3, shadeClose: true}, function () {
                            window.location.reload();
                        });
