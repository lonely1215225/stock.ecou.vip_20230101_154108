<?php /*a:2:{s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/index/index.html";i:1650948470;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="row">
            <div class="col-sm-12 no-padding">
                <div class="search-box">
                    ...
                    <div class="search-body"><input class="form-control" type="text" id="mobile" name="mobile" value=""></div>
                </div>
                <div class="search-box">
                    <label class="text-right"></label>
                    <div class="search-body">
                        <a href="#" class="btn btn-primary" onclick="exportExcel();">导出用户信息</a>
                    </div>
                </div>
            </div>
                ...
                <div class="box box-info">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">今日充值</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;color: #00c0ef;padding-right: 10px; text-align: right">
                                    <span style="color: #00c0ef; font-weight: bold"><?php echo !empty($userRechargeToday['real_money']) ? htmlentities($userRechargeToday['real_money']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">今日累计充值总金额</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="box box-info">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">今日提现</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;padding-right: 10px;text-align: right">
                                    <span style="color: #00c0ef; font-weight: bold"><?php echo !empty($userWithdrawToday['money']) ? htmlentities($userWithdrawToday['money']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">今日累计提现总金额</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="box box-info">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">今日注册</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;padding-right: 10px;text-align: right">
                                    <span style="color: #00c0ef; font-weight: bold"><?php echo !empty($registeredToday) ? htmlentities($registeredToday) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">今日累计注册总人数</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="box box-info">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">今日收入</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;padding-right: 10px; text-align: right">
                                    <span style="color: #00c0ef; font-weight: bold"><?php echo !empty($tradedStatistics['total_fee']) ? htmlentities($tradedStatistics['total_fee']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999;">今日综合费用收入</span>
                                </td>
                                <td style="float: right;font-size: 16px;padding-right: 10px; text-align: right">
                                    <span style="color: #00c0ef; font-weight: bold"><?php echo !empty($incomeStatistics['money']) ? htmlentities($incomeStatistics['money']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">今日管理费总收入</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="box box-info" style="border-color: #61ce3c">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">累计注册</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;padding-right: 10px;text-align: right">
                                    <span style="color: #61ce3c; font-weight: bold"><?php echo !empty($registeredTotal) ? htmlentities($registeredTotal) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">累计注册总人数</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="box box-info" style="border-color: #61ce3c">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">累计收入</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;padding-right: 10px; text-align: right">
                                    <span style="color: #61ce3c; font-weight: bold"><?php echo !empty($tradedTotal['total_fee']) ? htmlentities($tradedTotal['total_fee']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999;">累计综合费用收入</span>
                                </td>
                                <td style="float: right;font-size: 16px;padding-right: 10px; text-align: right">
                                    <span style="color: #61ce3c; font-weight: bold"><?php echo !empty($incomeTotal['money']) ? htmlentities($incomeTotal['money']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">累计管理费总收入</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="box box-info" style="border-color: #61ce3c">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">累计充值</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;padding-right: 10px;text-align: right">
                                    <span style="color: #61ce3c; font-weight: bold"><?php echo !empty($totalRecharge['real_money']) ? htmlentities($totalRecharge['real_money']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">累计充值金额</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="box box-info" style="border-color: #61ce3c">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">累计提现</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;padding-right: 10px;text-align: right">
                                    <span style="color: #61ce3c; font-weight: bold"><?php echo !empty($totalWithdraw['money']) ? htmlentities($totalWithdraw['money']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">累计提现金额</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="box box-info" style="border-color: #dd4b39">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">客户钱包余额</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;padding-right: 10px; text-align: right">
                                    <span style="color: #dd4b39; font-weight: bold"><?php echo !empty($userAccount['totalwallet']) ? htmlentities($userAccount['totalwallet']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">客户累计钱包余额</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="box box-info" style="border-color: #dd4b39">
                    <div class="box-body no-padding">
                        <table style="width: 100%;height: 90px;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="2">客户策略金余额</td>
                            </tr>
                            <tr>
                                <td style="float: right;font-size: 16px;color: #dd4b39;padding-right: 10px; text-align: right">
                                    <span style="color: #dd4b39; font-weight: bold"><?php echo !empty($userAccount['totalstrategy']) ? htmlentities($userAccount['totalstrategy']) : 0; ?></span>
                                    <p></p>
                                    <span style="color: #999999">客户累计策略金余额（含冻结）</span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="col-sm-12">
                <div class="box box-info" style="border-color: #00a65a">
                    <div class="box-body no-padding">
                        <table style="width: 100%;">
                            <tr>
                                <td style="font-size: 22px;padding-left: 10px;" valign="top" colspan="4">当前持仓统计</td>
                            </tr>
                            <?php foreach($positionStatistics as $key=>$item): ?>
                            <tr style="height: 60px;">
                                <!--<td class="std">
                                    <span style="font-weight: bold"><?php echo htmlentities($key); ?></span><br><span style="color: #999999">主账号</span>
                                </td>-->
                                <td class="std">
                                    <span style="font-weight: bold"><?php echo !empty($item['sum_buy_value_cost']) ? htmlentities($item['sum_buy_value_cost']) : 0; ?></span><br><span style="color: #999999">总买入市值</span>
                                </td>
                                <td class="std">
                                    <span style="font-weight: bold"><?php echo !empty($item['sum_sell_value_in']) ? htmlentities($item['sum_sell_value_in']) : 0; ?></span><br><span style="color: #999999">总卖出市值</span>
                                </td>
                                <td class="std">
                                    <span style="font-weight: bold"><?php echo !empty($item['sum_deposit']) ? htmlentities($item['sum_deposit']) : 0; ?></span><br><span style="color: #999999">
                                    持仓保证金
                                </span>
                                </td>
                            </tr>
...
function exportExcel() {
    ...
    if(mobile == ''){
        layer.msg("请输入手机号", {icon:2, time:1500, shade:.3, shadeClose:true});
    }else if(!isPoneAvailable(mobile)){
        layer.msg("请输入正确的手机号", {icon:2, time:1500, shade:.3, shadeClose:true});
    } else{
        window.location.href="<?php echo url('stock/indexStatistics/exportUserInfo'); ?>?mobile="+mobile;
    }
}
