<?php /*a:2:{s:75:"/www/wwwroot/stock.ecou.vip/application/dash/view/order/close_position.html";i:1554286782;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" name="start_date" id="startDate" value="<?php echo !empty($start_date) ? htmlentities($start_date) : ''; ?>" class="form-control pull-right" readonly />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" name="end_date" id="endDate" value="<?php echo !empty($end_date) ? htmlentities($end_date) : ''; ?>" class="form-control pull-right" readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="search-box">
                    ...
                    <div class="box-body no-padding table-scroll-x" id="scroll_tab"  onscroll="scrollWindow(this,'div1')">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlentities($v['b_cost_price']); ?></td>
