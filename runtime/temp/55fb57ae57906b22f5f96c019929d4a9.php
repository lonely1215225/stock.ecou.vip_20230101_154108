<?php /*a:2:{s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/order/order.html";i:1552016600;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="box-body no-padding table-scroll-x" id="scroll_tab"  onscroll="scrollWindow(this,'div1')">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr <?php echo $v['direction']=='buy' ? "class='buy'" : "class='sell'"; ?>>
                                ...
                                <td>
                                    <a href="<?php echo url('user/index', ['mobile' => $v['mobile']]); ?>" target="_blank" style="cursor: pointer" title="点击查看用户详情">
                                        <span>
                                            ...
                                            <br>
                                            <?php echo !empty($v['real_name']) ? htmlentities($v['real_name']) : ''; ?>
                                        </span>
                                    </a>
                                </td>
                                <td>
                                ...
                                <td><?php echo !empty($v['direction']) ? htmlentities($tradeDirectionList[$v['direction']]) : ''; ?><?php echo !empty($v['is_system']) ? '（强平）' : ''; ?></td>
                                <td><?php echo htmlentities($v['create_time']); ?></td>
                                <td><b><?php echo !empty($v['is_system']) ? '市价' : htmlentities($v['price']); ?></b></td>
                                <td><b><?php echo htmlentities($v['volume']); ?></b></td>
                                <td><b><?php echo htmlentities($v['volume_success']); ?></b></td>
                                <td><?php echo htmlentities($orderStateList[$v['state']]); ?></td>
                                <td>
                                    <?php if($v['is_system'] == false): if(in_array($v['state'], [ORDER_SUBMITTED, ORDER_PART_TRADED])): ?>
                                    <?php echo htmlentities($cancelStateList[$v['cancel_state']]); ?><?php echo $v['cancel_type']=='auto' ? '<br>（自动）' : ''; ?>
                                    <?php endif; ?>
                                    <?php endif; ?>
                                </td>
