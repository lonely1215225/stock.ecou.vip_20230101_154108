<?php /*a:2:{s:68:"/www/wwwroot/stock.ecou.vip/application/dash/view/news/cat_edit.html";i:1539486004;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
					...
					<form id="editForm" action="" method="post" class="form-horizontal">
						<div class="box-body">
							<div class="form-group col-sm-8">
								...
								<div class="col-sm-8">
									<input class="form-control" name="title" value="<?php echo htmlentities($catInfo['title']); ?>">
								</div>
							</div>
						</div>
						<div class="box-body">
							<div class="form-group col-sm-8">
								...
								<div class="col-sm-8 checkbox">
									<label>
										<input type="checkbox" name="is_show" id="is_show" <?php echo $catInfo['is_show']==1 ? 'checked' : ''; ?>>
									</label>
								</div>
							</div>
						</div>
						...
						<div class="box-footer">
							<div class="col-sm-8">
								<div class="col-sm-offset-2">
									<input type="hidden" name="id" id="id" value="<?php echo htmlentities($catInfo['id']); ?>">
...
$(function(){
    $("#editForm").submit(function(){
        ...
        if(title == "") {
            ...
            $.post("<?php echo url('stock/article/saveCat'); ?>", {id:id,title:title,is_show:is_show}, function(data){
                if(data.code == 1){
                    layer.msg(data.msg, {icon:1, time:1500, shade:.3, shadeClose:true}, function(){
                        window.location.href = "<?php echo url('cat_list'); ?>";
                    });
                } else {
