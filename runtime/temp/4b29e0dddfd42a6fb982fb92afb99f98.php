<?php /*a:2:{s:71:"/www/wwwroot/stock.ecou.vip/application/dash/view/user/do_withdraw.html";i:1549951486;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="box box-info">
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" value="<?php echo htmlentities($money); ?>" class="form-control"  disabled>
                                </div>
                            </div>
                        </div>
...
function agreeWithdraw(){
    var id = $("#id").val();
    $.post("<?php echo url('stock/userWithdraw/withdraw_checked'); ?>", {
        id:id,
    }, function (data) {
        if (data.code == 1) {
...
function refuseWithdraw(){
    var id = $("#id").val();
    $.post("<?php echo url('stock/userWithdraw/withdraw_failed'); ?>", {
        id:id,
    }, function (data) {
        if (data.code == 1) {
            layer.msg(data.msg, {icon: 1, time: 1500, shade: .3, shadeClose: true}, function () {
