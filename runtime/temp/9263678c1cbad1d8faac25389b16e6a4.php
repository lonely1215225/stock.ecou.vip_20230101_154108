<?php /*a:2:{s:73:"/www/wwwroot/stock.ecou.vip/application/dash/view/broker/account_log.html";i:1543219352;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="box box-info">
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select id="changeType" name="change_type" class="form-control" onchange="showBroker(this.value);">
                                            <option value="">请选择</option>
                                            <?php foreach($changeType as $ck=>$cv): ?>
                                            <option value="<?php echo htmlentities($ck); ?>" <?php echo isset($change_type) && $ck==$change_type?'selected':''; ?>><?php echo htmlentities($cv); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="box-body  no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr class="tj">
                                <td></td>
                                <td><?php echo !empty($totalChangeMoney['changemoney']) ? htmlentities($totalChangeMoney['changemoney']) : 0; ?></td>
                                <td></td>
                                <td></td>
                            </tr>
                            </thead>
