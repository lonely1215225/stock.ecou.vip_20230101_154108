<?php /*a:2:{s:68:"/www/wwwroot/stock.ecou.vip/application/dash/view/news/cat_list.html";i:1543298134;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header">
                        <a href="<?php echo url('cat_add'); ?>" class="btn btn-success">
                    ...
                    <div class="box-body">
                        <ul class="ce">
                            <?php foreach($catList as $k=>$tl): ?>
                                <li class="mulu_list">
                                    <span class="open"><?php echo htmlentities($k+1); ?></span>
                                    <div class="muleft">
                                        <!--<input type="checkbox" name="">-->
                                        <?php echo htmlentities($tl['title']); ?>
                                    </div>
                                    <div class="muright">
                                        <a href="<?php echo url('news/cat_edit', ['id'=>$tl['id']]); ?>">更改</a>
                                        <!--a href="#" onclick="delCat(<?php echo htmlentities($tl['id']); ?>);">删除</a-->
                                    </div>
                                    <div class="clear"></div>
                                </li>
                            <?php endforeach; ?>
  ...
  function delCat(v) {
      layer.confirm('确定要删除吗？', {
          ...
          if(id == "") {
              ...
              $.post("<?php echo url('stock/article/catDel'); ?>", {id:id}, function(data){
                  if(data.code == 1){
