<?php /*a:2:{s:75:"/www/wwwroot/stock.ecou.vip/application/dash/view/settings/trading_fee.html";i:1548133510;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="service_fee" id="service_fee" value="<?php echo htmlentities($tradingFee['service_fee']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">手续费最低收取</label>
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="service_fee_min" id="service_fee_min" value="<?php echo htmlentities($tradingFee['service_fee_min']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">管理费比例</label>
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="management_fee" id="management_fee" value="<?php echo htmlentities($tradingFee['management_fee']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">月管理费比例</label>
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="monthly_m_fee" id="monthly_m_fee" value="<?php echo htmlentities($tradingFee['monthly_m_fee']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">停牌管理费比例</label>
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="management_fee_s" id="management_fee_s" value="<?php echo htmlentities($tradingFee['management_fee_s']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">履约保证金比例</label>
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="deposit_rate" id="deposit_rate" value="<?php echo htmlentities($tradingFee['deposit_rate']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">停牌履约保证金比例</label>
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="deposit_rate_s" id="deposit_rate_s" value="<?php echo htmlentities($tradingFee['deposit_rate_s']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">印花税比例</label>
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="stamp_tax" id="stamp_tax" value="<?php echo htmlentities($tradingFee['stamp_tax']); ?>">
                                </div>
                            </div>
                            <div class="form-group col-sm-8">
                                <label class="col-sm-2 control-label">过户费比例</label>
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="transfer_fee" id="transfer_fee" value="<?php echo htmlentities($tradingFee['transfer_fee']); ?>">
                                </div>
                            </div>
                        </div>
...
$("#tradingFeeForm").submit(function () {
    $.post("<?php echo url('stock/system/saveTradingFee'); ?>", $(this).serializeArray(), function (data) {
        if(data.code == 1) {
