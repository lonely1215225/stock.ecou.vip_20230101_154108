<?php /*a:2:{s:75:"/www/wwwroot/stock.ecou.vip/application/dash/view/settings/payment_way.html";i:1556431960;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="box box-info">
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <?php if(isset($list)): foreach($list as $k=>$nl): ?>
                            <tr>
                                <td><?php echo htmlentities($nl['name']); ?></td>
                                <td>
                                    <?php echo !empty($nl['is_open']) ? '是' : '否'; ?>
                                    <br>
                                    <a href="#" onclick="isOpen('<?php echo htmlentities($nl['id']); ?>');" title="编辑是否开启">编辑</a>
                                </td>
                                <td><?php echo htmlentities($payment_way[$nl['pay_channel']]); ?></td>
                                <td>
                                    <?php echo htmlentities($nl['to_name']); ?>
                                    <br>
                                    <?php echo htmlentities($nl['to_org_name']); ?>
                                    <br>
                                    <?php echo htmlentities($nl['to_branch']); ?>
                                    <br>
                                    <?php echo htmlentities($nl['to_account']); ?>
                                </td>
                                <td><img layer-src="<?php echo htmlentities($nl['to_qrcode']); ?>" src="<?php echo htmlentities($nl['to_qrcode']); ?>" height="70"></td>
                                <td>
                                    <a class="btn btn-sm btn-primary mb5" href="<?php echo url('settings/edit_payment_way', ['id' => $nl['id']]); ?>">编辑</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            <?php endif; ?>
                    ...
                    <div class="box-footer">
                        <div class="col-sm-12 no-padding"><?php echo $list->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
function isOpen(v) {
    layer.confirm('确定要更改开启状态吗？', {
        ...
        if(v == "") {
            ...
            $.post("<?php echo url('stock/payCompany/isOpen'); ?>", {id:v}, function(data){
                if(data.code == 1){
