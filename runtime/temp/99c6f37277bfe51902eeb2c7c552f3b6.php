<?php /*a:2:{s:71:"/www/wwwroot/stock.ecou.vip/application/dash/view/broker/reset_pwd.html";i:1539660746;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="box box-info">
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="username" id="username" value="<?php echo !empty($agentInfo['username']) ? htmlentities($agentInfo['username']) : ''; ?>" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
...
$(function(){
    $("#agentForm").submit(function(){
        ...
        if (id == 0 && password == '') {
            ...
            $.post("<?php echo url('stock/broker/saveNewPwd'); ?>",{id:id,password:password}, function(data){
                if(data.code == 1){
