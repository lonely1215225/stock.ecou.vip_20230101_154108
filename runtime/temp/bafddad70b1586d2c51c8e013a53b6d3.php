<?php /*a:2:{s:71:"/www/wwwroot/stock.ecou.vip/application/dash/view/agent/edit_agent.html";i:1544686974;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <?php echo !empty($agentInfo) ? '编辑' : '添加'; ?>代理商
            <small></small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-xs-12">
                <form id="agentForm" action="" class="form-horizontal">
                    <div class="box box-info">
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <input name="username" id="username" value="<?php echo !empty($agentInfo['username']) ? htmlentities($agentInfo['username']) : ''; ?>" class="form-control" <?php echo isset($agentInfo) ?'disabled':''; ?>>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <input name="org_name" id="orgName" value="<?php echo !empty($agentInfo['org_name']) ? htmlentities($agentInfo['org_name']) : ''; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <input name="mobile" id="mobile" value="<?php echo !empty($agentInfo['mobile']) ? htmlentities($agentInfo['mobile']) : ''; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <input name="commission_rate" id="commissionRate" value="<?php echo !empty($agentInfo['commission_rate']) ? htmlentities($agentInfo['commission_rate']) : ''; ?>" class="form-control">
                                    <span class="input-group-addon ">%</span>
                                </div>
                                <?php if($lowerCommissionRate !==''): ?>
                                <div class="col-sm-5 control-label"><font color="red">(该代理商最低分成比例为<?php echo htmlentities($lowerCommissionRate); ?>%)</font></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <input name="user_rate" id="user_rate" value="<?php echo !empty($agentInfo['user_rate']) ? htmlentities($agentInfo['user_rate']) : ''; ?>" class="form-control">
                                    <span class="input-group-addon ">%</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <select id="isDenyLogin" name="is_deny_login" class="form-control">
                                        <option value="0" <?php echo isset($agentInfo)&&0==$agentInfo['is_deny_login']?'selected':''; ?>>否</option>
                                        <option value="1" <?php echo isset($agentInfo)&&1==$agentInfo['is_deny_login']?'selected':''; ?>>是</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <select id="isDenyCash" name="is_deny_cash" class="form-control">
                                        <option value="0" <?php echo isset($agentInfo)&&0==$agentInfo['is_deny_cash']?'selected':''; ?>>否</option>
                                        <option value="1" <?php echo isset($agentInfo)&&1==$agentInfo['is_deny_cash']?'selected':''; ?>>是</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-4">
                                    <textarea class="form-control" name="remark" id="remark" rows="3"><?php echo !empty($agentInfo['remark']) ? htmlentities($agentInfo['remark']) : ''; ?></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <input type="hidden" name="lowerCommissionRate" id="lowerCommissionRate" value="<?php echo htmlentities($lowerCommissionRate); ?>">
                </form>
            </div>
        </div>
    </section>
...
$(function () {
    $("#agentForm").submit(function () {
        var id = "<?php echo !empty($agentInfo['id']) ? htmlentities($agentInfo['id']) : 0; ?>";
        ...
        if (username == '') {
            ...
            $.post("<?php echo url('stock/agent/saveAgent'); ?>", {
                id: id,
                username: username,
                password: password,
                org_name: orgName,
