<?php /*a:2:{s:70:"/www/wwwroot/stock.ecou.vip/application/dash/view/user/wallet_log.html";i:1551260846;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <form id="searchInfo" action="<?php echo url('wallet_log'); ?>" method="get">
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select id="changeType" name="change_type" class="form-control">
                                            <option value="">请选择</option>
                                            <?php foreach($walletChangeType as $wk=>$wv): ?>
                                            <option value="<?php echo htmlentities($wk); ?>" <?php echo isset($change_type) && $wk==$change_type?'selected':''; ?>><?php echo htmlentities($wv); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <?php foreach($walletLogAll['walletLogInfo'] as $k=>$v): ?>
                            <tr>
                                ...
                                <td><?php echo !empty($v['change_type']) ? htmlentities($walletChangeType[$v['change_type']]) : ''; ?></td>
                                ...
                                <td><?php echo !empty($walletLogAll['agentInfo'][$v['agent_id']]) ? htmlentities($walletLogAll['agentInfo'][$v['agent_id']]) : ''; ?>
                                    <br><?php echo !empty($walletLogAll['brokerInfo'][$v['broker_id']]) ? htmlentities($walletLogAll['brokerInfo'][$v['broker_id']]) : ''; ?>
                                </td>
                    ...
                    <div class="box-footer">
                        <div class="col-sm-12 no-padding"><?php echo $walletLogAll['walletLogInfo']->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
function exportJournalLog() {
    window.location.href="<?php echo url('stock/User/exportJournalLog', ['agent_id' => $agent_id,'broker_id'=>$broker_id,'mobile'=>$mobile,'change_type'=>$change_type,'start_date'=>$start_date,'end_date'=>$end_date]); ?>";
}
</script>
