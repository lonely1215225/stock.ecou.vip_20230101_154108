<?php /*a:2:{s:65:"/www/wwwroot/stock.ecou.vip/application/dash/view/news/index.html";i:1560501164;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header">
                        <a href="<?php echo url('news/news_edit'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> 添加文章</a>
                        <a href="#" class="btn btn-success" style="width: 100px;display: none;" id="delAll" onclick="delAllNews();">删除</a>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tbody>
                            <?php foreach($newsList as $k=>$nl): ?>
                                <tr>
                                    <td><input type="checkbox" name="ids" class="check-item" value="<?php echo htmlentities($nl['id']); ?>"></td>
                                    <td><?php echo htmlentities($k+1); ?></td>
                                    <td><a href="<?php echo url('news/news_edit', ['id'=>$nl['id']]); ?>" class="name"><?php echo htmlentities($nl['title']); ?></a></td>
                                    <td><?php echo htmlentities($nl['update_time']); ?></td>
                                    <td><?php echo htmlentities($nl['cat_name']); ?></td>
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="<?php echo url('news/news_edit', ['id' => $nl['id']]); ?>">编辑</a>
                                        <a class="btn btn-sm btn-warning" href="#" onclick="delNews(<?php echo htmlentities($nl['id']); ?>);">删除</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                    ...
                    <div class="box-footer">
                        <div class="col-sm-12 no-padding"><?php echo $newsList->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    function delNews(v) {
        layer.confirm('确定要删除吗？', {
            ...
            if(id == "") {
                ...
                $.post("<?php echo url('stock/article/newsDel'); ?>", {id:id}, function(data){
                    if(data.code == 1){
