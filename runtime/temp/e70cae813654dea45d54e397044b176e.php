<?php /*a:2:{s:76:"/www/wwwroot/stock.ecou.vip/application/dash/view/settings/trading_time.html";i:1547717646;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-middle">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" name="am_market_open_time" id="am_market_open_time" value="<?php echo htmlentities($marketTime['am_market_open_time']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th>上午休市时间</th>
                                    <td>
                                        <input class="form-control" name="am_market_close_time" id="am_market_close_time" value="<?php echo htmlentities($marketTime['am_market_close_time']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th>下午开市时间</th>
                                    <td>
                                        <input class="form-control" name="pm_market_open_time" id="pm_market_open_time" value="<?php echo htmlentities($marketTime['pm_market_open_time']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th>下午休市时间</th>
                                    <td>
                                        <input class="form-control" name="pm_market_close_time" id="pm_market_close_time" value="<?php echo htmlentities($marketTime['pm_market_close_time']); ?>">
                                    </td>
                                </tr>
                                <tr>
...
$(function () {
    ...
    $("#tradingTimeForm").submit(function () {
        $.post("<?php echo url('stock/system/saveMarketTime'); ?>", $(this).serializeArray(), function (data) {
            if(data.code == 1) {
