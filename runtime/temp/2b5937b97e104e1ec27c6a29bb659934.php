<?php /*a:2:{s:70:"/www/wwwroot/stock.ecou.vip/application/agent/view/my/do_withdraw.html";i:1541149598;s:67:"/www/wwwroot/stock.ecou.vip/application/agent/view/base/layout.html";i:1551173342;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <?php if($accountInfo): ?>
                            <tr>
                                <td><?php echo !empty($accountInfo['balance']) ? htmlentities($accountInfo['balance']) : ''; ?></td>
                                <td><?php echo !empty($accountInfo['total_commission']) ? htmlentities($accountInfo['total_commission']) : ''; ?></td>
                                <td><?php echo !empty($accountInfo['total_withdraw']) ? htmlentities($accountInfo['total_withdraw']) : ''; ?></td>
                                <td><?php echo !empty($accountInfo['update_time']) ? htmlentities($accountInfo['update_time']) : ''; ?></td>
                                <td>
                                    <a class="btn btn-sm btn-primary mb5" href="<?php echo url('withdraw'); ?>">提现</a>
                                </td>
                            </tr>
                            <?php endif; ?>
                            </tbody>
