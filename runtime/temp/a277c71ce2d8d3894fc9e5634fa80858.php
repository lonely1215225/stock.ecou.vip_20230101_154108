<?php /*a:2:{s:78:"/www/wwwroot/stock.ecou.vip/application/dash/view/settings/buy_limit_rate.html";i:1543296268;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="box-body">
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="limit_rate" id="limit_rate" value="<?php echo !empty($limit_rate) ? htmlentities($limit_rate) : ''; ?>">
                                </div>
                            </div>
                        </div>
...
$("#buyLimitRateForm").submit(function () {
    ...
    if (isNaN(v) || (v > 0.1) || v <= 0) {
        ...
        $.post("<?php echo url('stock/system/saveBuyLimitRate'); ?>", {limit_rate:v}, function (data) {
            if(data.code == 1) {
