<?php /*a:2:{s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/agent/index.html";i:1543223464;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <a href="<?php echo url('agent/edit_agent'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> 添加代理商</a>
                    </div>
                            ...
                            <form id="searchInfo" action="<?php echo url('index'); ?>" method="get">
                                <div class="col-sm-12 no-padding">
                                    <div class="search-box">
                                        ...
                                        <div class="search-body">
                                            <select id="agentId" name="agent_id" class="form-control">
                                                ...
                                                <?php foreach($agentList as $ak=>$av): ?>
                                    ...
                                    <div class="search-box">
                                        ...
                                        <div class="search-body">
                                            <input type="text" id="mobile" name="mobile" class="form-control" value="<?php echo !empty($mobile) ? htmlentities($mobile) : ''; ?>">
                                        </div>
                                    </div>
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr class="tj">
                                ...
                                <td></td>
                                <td></td>
                                <td><?php echo !empty($totalDetail['totalbalance']) ? htmlentities($totalDetail['totalbalance']) : ''; ?></td>
                                <td><?php echo !empty($totalDetail['totalcommission']) ? htmlentities($totalDetail['totalcommission']) : ''; ?></td>
                                <td><?php echo !empty($totalDetail['totalwithdraw']) ? htmlentities($totalDetail['totalwithdraw']) : ''; ?></td>
                                <td></td>
                            </tr>
                            </thead>
                            <tr>
                            ...
                            <?php foreach($agentInfo as $k=>$nl): ?>
                            <tr>
                                    <td><?php echo htmlentities($nl['username']); ?></td>
                                    <td><?php echo htmlentities($nl['org_name']); ?></td>
                                    <td><?php echo htmlentities($nl['mobile']); ?></td>
                                    <td><?php echo htmlentities($nl['commission_rate']); ?>%</td>
                                    <td><?php echo !empty($nl['is_deny_login']) ? '是'  :  '否'; ?></td>
                                    <td><?php echo !empty($nl['is_deny_cash']) ? '是'  :  '否'; ?></td>
                                    <td><?php echo !empty($orgAccount[$nl['id']]['balance']) ? htmlentities($orgAccount[$nl['id']]['balance']) : ''; ?></td>
                                    <td><?php echo !empty($orgAccount[$nl['id']]['total_commission']) ? htmlentities($orgAccount[$nl['id']]['total_commission']) : ''; ?></td>
                                    <td><?php echo !empty($orgAccount[$nl['id']]['total_withdraw']) ? htmlentities($orgAccount[$nl['id']]['total_withdraw']) : ''; ?></td>
                                    <td>
                                        <a class="btn btn-sm btn-primary mb5" href="<?php echo url('agent/edit_agent', ['id' => $nl['id']]); ?>">编辑</a>
                                        <br>
                                        <a class="btn btn-sm btn-primary mb5" href="<?php echo url('agent/reset_pwd', ['id' => $nl['id']]); ?>">重置密码</a>
                                        <br>
                                        <a class="btn btn-sm btn-primary mb5" href="<?php echo url('agent/show_broker', ['id' => $nl['id']]); ?>">查看经济人</a>
                                        <br>
                                        <a class="btn btn-sm btn-primary mb5" href="<?php echo url('user/index', ['agent_id' => $nl['id']]); ?>" target="_blank">查看用户</a>
                                    </td>
                            </tr>
                            <?php endforeach; ?>
                        </table>
                    ...
                    <div class="box-footer">
                        <div class="col-sm-12 no-padding"><?php echo $agentInfo->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
