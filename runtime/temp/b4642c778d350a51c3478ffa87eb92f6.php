<?php /*a:2:{s:64:"/www/wwwroot/stock.ecou.vip/application/dash/view/risk/xrxd.html";i:1654349692;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header">
                        <a href="<?php echo url('risk/edit_xrxd'); ?>" class="btn btn-success"><i class="fa fa-plus"></i>
                            添加除权除息</a>
                        <form id="searchInfo" action="<?php echo url('xrxd'); ?>" method="get">
                            <div class="col-sm-12 no-padding">
                                <div class="search-box">
                                    <label class="text-right">股票代码</label>
                                    <div class="search-body"><input class="form-control" type="text" id="stockCode" name="stock_code" value="<?php echo !empty($stock_code) ? htmlentities($stock_code) : ''; ?>"></div>
                                </div>
                                <div class="search-box">
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-body">
                                        <select id="isFinished" name="is_finished" class="form-control">
                                            ...
                                            <option value="1" <?php echo $is_finished!="" && 1==$is_finished?'selected':''; ?>>已分配</option>
                                            <option value="0" <?php echo $is_finished!="" && 0==$is_finished?'selected':''; ?>>未分配</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="search-box">
                    ...
                    <!--div class="box-body no-padding">
                        <table class="table table-bordered table-middle">
                            <tr>
                                <td>
                                    除权除息总数：<?php echo !empty($xrxdTotal) ? htmlentities($xrxdTotal) : '0'; ?>
                                </td>
                            </tr>
                        </table>
                    </div-->
                    <div class="box-body">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tbody>
                            <?php foreach($xrxdInfo['xrxdList'] as $k=>$nl): ?>
                            <tr>
                                <td><?php echo $page?(($page-1)*15+($k+1)):($k+1); ?></td>
                                <td>
                                    <?php echo htmlentities($nl['market']); ?><?php echo htmlentities($nl['stock_code']); ?>
                                </td>
                                <td>
                                    <?php echo !empty($xrxdInfo['stockName'][$nl['market'].$nl['stock_code']]['stock_name']) ? htmlentities($xrxdInfo['stockName'][$nl['market'].$nl['stock_code']]['stock_name']) : ''; ?>
                                </td>
                                <td><?php echo htmlentities($nl['base_volume']); ?></td>
                                <td><?php echo htmlentities($nl['give_volume']); ?></td>
                                <td><?php echo htmlentities($nl['transfer_volume']); ?></td>
                                <td><?php echo htmlentities($nl['account_volume']); ?></td>
                                <td><?php echo htmlentities($nl['dividend']); ?></td>
                                <td><?php echo htmlentities($nl['execute_date']); ?> </td>
                                <td><?php echo htmlentities($nl['remark']); ?></td>
                                <td><?php echo !empty($nl['is_finished']) ? '已分配' : '未分配'; ?></td>
                                <td>
                                    <a class="btn btn-sm btn-primary" href="<?php echo url('risk/detail_xrxd', ['id' => $nl['id']]); ?>">查看策略</a>
                                    <a class="btn btn-sm btn-primary" href="<?php echo url('risk/edit_xrxd', ['id' => $nl['id']]); ?>">编辑</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
                    ...
                    <div class="box-footer">
                        <div class="col-sm-12 no-padding"><?php echo $xrxdInfo['infoList']->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
