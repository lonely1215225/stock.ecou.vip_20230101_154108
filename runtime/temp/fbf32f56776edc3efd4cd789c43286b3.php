<?php /*a:2:{s:70:"/www/wwwroot/stock.ecou.vip/application/dash/view/user/yuebao_log.html";i:1559550626;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <form id="searchInfo" action="<?php echo url('yuebao_log'); ?>" method="get">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr class="tj">
                                <th>总计</th>
                                <th colspan="4"></th>
                                <th><?php echo htmlentities((isset($yuebaoAccount['totalaccount']) && ($yuebaoAccount['totalaccount'] !== '')?$yuebaoAccount['totalaccount']:'0')); ?></th>
                                <th colspan="4"></th>
                            </tr>
                            </thead>
                            <thead>
                            ...
                            <?php foreach($yuebaoLogAll['yuebaoLogInfo'] as $k=>$v): ?>
                            <tr>
                                ...
                                <td><?php echo htmlentities($v['income_time']); ?></td>
                                <td><?php echo htmlentities($v['wallet_balance']); ?></td>
                                <td><?php echo htmlentities($v['income']); ?></td>
                                <td><?php echo htmlentities($v['base_income']); ?></td>
                                <td><?php echo !empty($v['is_received']) ? '是' : '否'; ?></td>
                                <td><?php echo htmlentities($v['total_yuebao']); ?></td>
                                <td><?php echo !empty($yuebaoLogAll['agentInfo'][$v['agent_id']]) ? htmlentities($yuebaoLogAll['agentInfo'][$v['agent_id']]) : ''; ?>
                                    <br><?php echo !empty($yuebaoLogAll['brokerInfo'][$v['broker_id']]) ? htmlentities($yuebaoLogAll['brokerInfo'][$v['broker_id']]) : ''; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </table>
                    ...
                    <div class="box-footer">
                        <div class="col-sm-12 no-padding"><?php echo $yuebaoLogAll['yuebaoLogInfo']->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
