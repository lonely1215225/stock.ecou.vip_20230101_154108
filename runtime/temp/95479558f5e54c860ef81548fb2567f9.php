<?php /*a:2:{s:67:"/www/wwwroot/stock.ecou.vip/application/dash/view/income/index.html";i:1547718140;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-middle table-center">
                            ...
                            <tr class="tj">
                                ...
                                <td></td>
                                <td></td>
                                <td><?php echo !empty($adminStatistic) ? htmlentities($adminStatistic['money']) : ''; ?></td>
                                <td><?php echo !empty($adminStatistic) ? htmlentities($adminStatistic['platform_money']) : ''; ?></td>
                                <td></td>
                                <td><?php echo !empty($adminStatistic) ? htmlentities($adminStatistic['agent_money']) : ''; ?></td>
                                <td></td>
                                <td><?php echo !empty($adminStatistic) ? htmlentities($adminStatistic['broker_money']) : ''; ?></td>
                                <td></td>
                                <td></td>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo url('user/index',['mobile'=>$nl['mobile']]); ?>" title="点击打开用户详情">
                                ...
                                <td><?php echo htmlentities($nl['money']); ?></td>
                                <td><?php echo !empty($nl['platform_money']) ? htmlentities($nl['platform_money']) : ''; ?></td>
                                <td><?php echo !empty($nl['agent_id']) ? htmlentities($incomeList['agent'][$nl['agent_id']]) : ''; ?></td>
                                <td><?php echo !empty($nl['agent_money']) ? htmlentities($nl['agent_money']) : ''; ?></td>
                                <td><?php echo !empty($nl['broker_id']) ? htmlentities($incomeList['broker'][$nl['broker_id']]) : ''; ?></td>
