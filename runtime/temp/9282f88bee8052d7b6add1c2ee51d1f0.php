<?php /*a:2:{s:74:"/www/wwwroot/stock.ecou.vip/application/dash/view/settings/yuebao_set.html";i:1651988465;s:66:"/www/wwwroot/stock.ecou.vip/application/dash/view/base/layout.html";i:1665562605;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="col-sm-8 checkbox">
                                    <label>
                                        <input type="checkbox" name="is_open" id="is_open" <?php echo $yuebao['is_open']==1 ? 'checked' : ''; ?> value="0">
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <div class="input-group col-sm-8">
                                    <input class="form-control" name="yuebao_fee" id="yuebao_fee"
                                           value="<?php echo htmlentities($yuebao['yuebao_fee']); ?>">
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $("#tradingFeeForm").submit(function () {
        ...
        $.post("<?php echo url('stock/system/saveYuebao'); ?>", $(this).serializeArray(), function (data) {
            if (data.code == 1) {
